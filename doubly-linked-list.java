public class CalderKatyal_DoublyLinkedListClass{
    ...
    DoublyLinkedList l;        
      ...
      try{
        ...
        l.print(); l.reversePrint();  System.out.print("first="+l.first+" last="+l.last);System.out.println(" Test 1:          \tcorrect output: []  first=null,last=null");
      } catch(Exception e){
      ...
      try{
        l = new DoublyLinkedList();
        l.add(0);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data);System.out.println(" Test 2:          \tcorrect output: [0] first=0,last=0");
      } catch(Exception e){
        System.out.println(e);
      ...
      try{
        ...
        l.add(0);
        l.add(1);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 3:          \tcorrect output: [0, 1] first=0,last=1");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(1);
        l.add(2);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 4:          \tcorrect output: [0, 1, 2]  first=0,last=2");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(0);
        l.remove();
        l.print(); l.reversePrint();  System.out.print("first="+l.first+" last="+l.last); System.out.println(" Test 6:          \tcorrect output: []  first=null,last=null");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(1);
        l.remove();
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 7:         \tcorrect output: [0] first=0,last=0");
      } catch(Exception e){
        System.out.println(e);
      ...
      try{
        ...
        l.add(0);
        l.add(0, 1);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 15:         \tcorrect output: [1, 0]  first=1,last=0");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(0, 1);
        l.add(1, 2);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 16:         \tcorrect output: [1, 2, 0] first=1,last=0");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(1, 2);
        l.add(3, 3);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 17:         \tcorrect output: [1, 2, 0, 3]  first=1,last=3");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        l = new DoublyLinkedList();
        l.add(0, 1);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 18:         \tcorrect output: [1]  first=1,last=1");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.print(); l.reversePrint();  System.out.print("first="+l.first+" last="+l.last); System.out.println(" Test 19:         \tcorrect output: [] first=null,last=null");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.print(); l.reversePrint();  System.out.print("first="+l.first+" last="+l.last); System.out.println(" Test 20:         \tcorrect output: [] first=null,last=null");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(0);
        l.remove(1); // should NOT cause a run time error
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 21:         \tcorrect output: [0]  first=0,last=0");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(0);
        l.remove(0);
        l.print(); l.reversePrint();  System.out.print("first="+l.first+" last="+l.last); System.out.println(" Test 22:        \tcorrect output: [] first=null,last=null");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(1);
        l.remove(0);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 23:        \tcorrect output: [1] first=1,last=1");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(1);
        l.remove(0);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 24:        \tcorrect output: [1] first=1,last=1");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(3);
        l.remove(2);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 25:        \tcorrect output: [0, 1, 3] first=0,last=3");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.remove(2);
        l.remove(2);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 26:        \tcorrect output: [0, 1] first=0,last=1");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(0);
        l.set(0, 99);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 33:         \tcorrect output: [99] first=99,last=99");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.set(1, 98);
        l.set(2, 97);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println(" Test 34:         \tcorrect output: [99, 98, 97] first=99,last=97");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        l = new DoublyLinkedList();
        l.clear();
        l.print(); l.reversePrint();  System.out.print("first="+l.first+" last="+l.last);System.out.println("Test 40:        \tcorrect output: [] first=null,last=null");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(0);
        l.clear();
        l.print(); l.reversePrint();  System.out.print("first="+l.first+" last="+l.last);System.out.println("Test 41:        \tcorrect output: [] first=null,last=null");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(2);
        l.clear();
        l.print(); l.reversePrint();  System.out.print("first="+l.first+" last="+l.last);System.out.println("Test 42:        \tcorrect output: [] first=null,last=null");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 46:        \tcorrect output: [0, 1] first=0,last=1");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(1);
        l.swap(0,1);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 47:        \tcorrect output: [1, 0] first=1,last=0");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(3);
        l.swap(0,1);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 48:        \tcorrect output: [1, 0, 2, 3] first=1,last=3");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(3);
        l.swap(0,2);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 49:        \tcorrect output: [2, 1, 0, 3] first=2,last=3");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(3);
        l.swap(0,3);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 50:       \tcorrect output: [3, 1, 2, 0] first=3,last=0");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(4);
        l.swap(0,3);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 51:        \tcorrect output: [3, 1, 2, 0, 4] first=3,last=4");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(4);
        l.swap(2,3);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 52:         \tcorrect output: [0, 1, 3, 2, 4] first=0,last=4");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(4);
        l.swap(1,3);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 53:        \tcorrect output: [0, 3, 2, 1, 4] first=0,last=4");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(5);
        l.swap(1,4);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 54:       \tcorrect output: [0, 4, 2, 3, 1, 5] first=0,last=5");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(3);
        l.swap(2,3);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 55:        \tcorrect output: [0, 1, 3, 2] first=0,last=2");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(3);
        l.swap(1,3);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 56:         \tcorrect output: [0, 3, 2, 1] first=0,last=1");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.print(); l.reversePrint();  System.out.println("Test 59:        \tcorrect output: [0, 1]");
      } catch(Exception e){
        System.out.println(e);
      ...
      try{
        ...
        l.add(1);
        l.swap(1,0);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 60:        \tcorrect output: [1, 0] first=1,last=0");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(3);
        l.swap(1,0);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 61:         \tcorrect output: [1, 0, 2, 3] first=1,last=3");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(3);
        l.swap(2,0);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 62:        \tcorrect output: [2, 1, 0, 3] first=2,last=3");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(3);
        l.swap(3,0);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 63:        \tcorrect output: [3, 1, 2, 0] first=3,last=0");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(4);
        l.swap(3,0);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data);  System.out.println("Test 64:         \tcorrect output: [3, 1, 2, 0, 4] first=3,last=4");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(4);
        l.swap(3,2);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 65:         \tcorrect output: [0, 1, 3, 2, 4] first=0,last=4");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(4);
        l.swap(3,1);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 66:         \tcorrect output: [0, 3, 2, 1, 4] first=0,last=4");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(5);
        l.swap(4,1);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 67:         \tcorrect output: [0, 4, 2, 3, 1, 5] first=0,last=5");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(3);
        l.swap(3,2);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 68:         \tcorrect output: [0, 1, 3, 2] first=0,last=2");
      } catch(Exception e){
        System.out.println(e);
      ...
      try {
        ...
        l.add(3);
        l.swap(3,1);
        l.print(); l.reversePrint();  System.out.print("first="+l.first.data+" last="+l.last.data); System.out.println("Test 69:  \tcorrect output: [0, 3, 2, 1] first=0,last=1");
      } catch(Exception e){
        System.out.println(e);
   ...
   void add(int value){ //add the given value to the end of the linked list
    ...
    int remove(int pos){  //remove node at position pos and return the int value of that item
      ...
      if(pos==0){ //removing the first Node
        ...
        getNode(pos).prev=getNode(pos-1);
      }
      return a;
    }
    ...
    void reversePrint(){  //prints the nodes in reverse order (from last to first)
     System.out.print("[");
      ...
      while(temp!=null){//if there is an item at temp
        System.out.print(temp.data);
        if (temp.prev!=null){ //if there is a value after temp
          System.out.print(",");
        }
        temp=temp.prev;
      }
      ...
      if(a<0||a>size()-1||b<0||b>size()-1){
        ...
        if(a+1==b){   //if they are next to each other
          ...
          if(a!=0){ //if a is not 0
            ...
            tempaafter.prev=tempb;
            tempbbefore.next=tempa;
            tempa.prev=tempbbefore;
            tempa.next=tempbnext;
            if(tempbnext!=null){
            tempbnext.prev=tempa; 
            } 
